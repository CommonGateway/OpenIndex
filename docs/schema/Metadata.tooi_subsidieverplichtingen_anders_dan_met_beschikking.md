...
![Class Diagram](https://github.com/CommonGateway/OpenIndex/blob/tilburg-cases-sync/docs/schema/Metadata.tooi_subsidieverplichtingen_anders_dan_met_beschikking.svg)
