# Metadata TOOI overige besluiten van algemene strekking

Overige besluiten van algemene strekking. 

![Class Diagram](https://github.com/CommonGateway/OpenIndex/blob/make-bundle-installable/docs/schema/Metadata.tooi_overige_besluiten_van_algemene_strekking.svg)
