...
![Class Diagram](https://github.com/CommonGateway/OpenIndex/blob/make-bundle-installable/docs/schema/Metadata.tooi_agendas_en_besluitenlijsten_bestuurscolleges.svg)
