# Metadata TOOI vergaderstukken Staten-Generaal
...
![Class Diagram](https://github.com/CommonGateway/OpenIndex/blob/required-categorie-naam/docs/schema/Metadata.tooi_vergaderstukken_staten_generaal.svg)
