...
![Class Diagram](https://github.com/CommonGateway/OpenIndex/blob/tilburg-cases-sync/docs/schema/Metadata.tooi_wetten_en_algemeen_verbindende_voorschriften.svg)
