...
class InstallationService implements InstallerInterface
{
    ...
    {
        $this->logger->debug("OpenIndex -> Install()", ['plugin' => 'common-gateway/open-index']);
    ...
    {
        $this->logger->debug("OpenIndex -> Update()", ['plugin' => 'common-gateway/open-index']);
    ...
    {
        $this->logger->debug("OpenIndex -> Uninstall()", ['plugin' => 'common-gateway/open-index']);
